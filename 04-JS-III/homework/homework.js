...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
return array.includes(elemento); // .includes recorre todo el array comparando sus elementos devolviendo V/F 
}
...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
 return Math.max (...numeros);  //math.max devuelve elnumero mas grande de los valores ingresados
}                               //(...) (operador spread) Expande el array en valores individuales
